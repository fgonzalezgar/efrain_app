        ...
        <div class="min-h-screen flex">
            ...
            <aside class="w-[240px] bg-white border-r border-gray-200 flex-col hidden md:flex h-screen sticky top-0">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('clientes.*') ? 'true' : 'false' }} }" class="mt-2">
                        <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm transition-colors {{ request()->routeIs('clientes.*') ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
                        ...
                        <div x-show="open" style="display: {{ request()->routeIs('clientes.*') ? 'block' : 'none' }};" class="mt-1 space-y-1 pl-11 pr-3">
                            <a href="{{ route('clientes.index') }}" class="block px-3 py-2 rounded-lg text-sm transition-colors {{ request()->routeIs('clientes.index') ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
                                Listado
                            </a>
                            <a href="{{ route('clientes.upload') }}" class="block px-3 py-2 rounded-lg text-sm transition-colors {{ request()->routeIs('clientes.upload') ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
                                Importar
                            </a>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: {{ request()->routeIs('responsibles.*') ? 'true' : 'false' }} }" class="mt-2">
                        <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm transition-colors {{ request()->routeIs('responsibles.*') ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
                            <div class="flex items-center gap-3">
                        ...
                        <div x-show="open" style="display: {{ request()->routeIs('responsibles.*') ? 'block' : 'none' }};" class="mt-1 space-y-1 pl-11 pr-3">
                            <a href="{{ route('responsibles.index') }}" class="block px-3 py-2 rounded-lg text-sm transition-colors {{ request()->routeIs('responsibles.index') ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
                                Listado
                            </a>
                            <a href="{{ route('responsibles.upload') }}" class="block px-3 py-2 rounded-lg text-sm transition-colors {{ request()->routeIs('responsibles.upload') ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
                                Importar
                            </a>
                        </div>
                    </div>
                    <div x-data="{ open: {{ request()->routeIs('procesos.*') ? 'true' : 'false' }} }" class="mt-2">
                        <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm transition-colors {{ request()->routeIs('procesos.*') ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
                            <div class="flex items-center gap-3">
                        ...
                        <div x-show="open" style="display: {{ request()->routeIs('procesos.*') ? 'block' : 'none' }};" class="mt-1 space-y-1 pl-11 pr-3">
                            <a href="{{ route('procesos.create') }}" class="block px-3 py-2 rounded-lg text-sm transition-colors {{ request()->routeIs('procesos.create') ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
                                Registro
                            </a>
                        </div>
                    </div>
