            ...
            <aside class="w-[240px] bg-white border-r border-gray-200 flex-col hidden md:flex h-screen sticky top-0">
                ...
                <div class="h-[72px] flex items-center px-6 border-b border-gray-100 shrink-0">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                        <div class="bg-[#1e325c] text-white p-1.5 rounded-lg">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
                        </div>
                        <div>
                            <span class="text-xl font-bold text-[#0f172a] block leading-tight">JurisTech</span>
                            <span class="text-[10px] text-gray-500 font-medium tracking-wide">Gestión de Datacrédito</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="px-4 py-6 border-t border-gray-100 shrink-0">
                    <button class="w-full bg-[#1e58c8] hover:bg-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg text-sm shadow-sm transition-colors mb-6">
                        Radicar Queja
                    </button>
            ...
            <div class="flex-1 flex flex-col min-w-0">
                ...
                <header class="h-[72px] bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-10 shrink-0">
                    ...
                    <div class="flex items-center gap-5">
                        @if(request()->routeIs('dashboard'))
                            <button class="hidden sm:block bg-[#1e58c8] hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg text-sm shadow-sm transition-colors">
                                Preparar Tutela
                            </button>
                        @elseif(request()->routeIs('clientes.index'))
                            <button class="hidden sm:block bg-[#0f172a] hover:bg-gray-800 text-white font-semibold py-2 px-4 rounded-lg text-sm shadow-sm transition-colors">
                                Preparar Tutela
                            </button>
                        @endif
