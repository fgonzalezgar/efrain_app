<x-app-layout>
    <div class="max-w-7xl mx-auto py-4">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-[28px] font-bold text-[#0f172a] tracking-tight">Responsibles</h1>
                <p class="text-[15px] text-gray-600 mt-1">Manage your legal team, monitor workloads, and assign active cases.</p>
            </div>
            <a href="{{ route('responsibles.create') }}" class="bg-[#1e58c8] hover:bg-blue-700 text-white font-semibold py-2.5 px-5 rounded-lg text-sm shadow-sm flex items-center gap-2 transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                <p class="text-xs font-bold text-gray-500 tracking-wider uppercase mb-2">Total Professionals</p>
                <div class="flex items-end gap-2">
                    <span class="text-3xl font-bold text-[#0f172a]">{{ $responsibles->total() }}</span>
                    <span class="text-xs font-semibold text-emerald-600 mb-1">+2 this month</span>
                </div>
            </div>
            
            <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                <p class="text-xs font-bold text-gray-500 tracking-wider uppercase mb-2">Active Lawyers</p>
                <div class="flex items-end gap-2">
                    <span class="text-3xl font-bold text-[#0f172a]">{{ $responsibles->where('status', 'active')->count() }}</span>
                    <span class="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded ml-1 mb-1.5">75% CAPACITY</span>
                </div>
            </div>
            
            <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                <p class="text-xs font-bold text-gray-500 tracking-wider uppercase mb-2">Avg. Case Load</p>
                <div class="flex items-end gap-2">
                    <span class="text-3xl font-bold text-[#0f172a]">12.4</span>
                    <span class="text-xs font-medium text-gray-500 mb-1">Cases / Professional</span>
                </div>
            </div>
            
            <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                <p class="text-xs font-bold text-gray-500 tracking-wider uppercase mb-2">Pending Reviews</p>
                <div class="flex items-end gap-2">
                    <span class="text-3xl font-bold text-red-600">7</span>
                    <span class="text-[10px] font-bold text-red-700 bg-red-100 px-2 py-0.5 rounded ml-1 mb-1.5">URGENT</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200">
                            <th class="py-3 px-6 text-xs font-bold text-gray-600 uppercase tracking-wider">Professional Name</th>
                            <th class="py-3 px-6 text-xs font-bold text-gray-600 uppercase tracking-wider">Role</th>
                            <th class="py-3 px-6 text-xs font-bold text-gray-600 uppercase tracking-wider">Assigned Cases</th>
                            <th class="py-3 px-6 text-xs font-bold text-gray-600 uppercase tracking-wider">Status</th>
                            <th class="py-3 px-6 text-xs font-bold text-gray-600 uppercase tracking-wider text-right">Actions</th>
                        </tr>
                    </thead>
            ...
            <div class="bg-white border-t border-gray-200 px-6 py-3 flex items-center justify-between">
                <p class="text-xs text-gray-500">
                    Showing <span class="font-bold">{{ $responsibles->firstItem() }}</span>-<span class="font-bold">{{ $responsibles->lastItem() }}</span> of <span class="font-bold">{{ $responsibles->total() }}</span> legal professionals
                </p>
                <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div class="col-span-2 bg-white border border-gray-200 rounded-xl p-6 shadow-sm flex flex-col">
                <h3 class="text-sm font-bold text-gray-800 mb-6">Expertise Distribution</h3>
                <div class="flex-grow flex items-end justify-between px-8 pb-4">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-[10px] font-bold text-gray-500 uppercase">Civil Law</span>
                    </div>
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-[10px] font-bold text-gray-500 uppercase">Commercial</span>
                    </div>
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-[10px] font-bold text-gray-500 uppercase">Administrative</span>
                    </div>
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-[10px] font-bold text-gray-500 uppercase">Labor Law</span>
                    </div>
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-[10px] font-bold text-gray-500 uppercase">Criminal</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#0f172a] rounded-xl p-6 shadow-sm text-white flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <span class="inline-block px-2 py-1 bg-[#1e58c8] text-[10px] font-bold uppercase tracking-wider rounded mb-4">Monthly Spotlight</span>
                    <h3 class="text-xl font-bold mb-2">Top Performance</h3>
                    <p class="text-sm text-gray-300 leading-relaxed mb-6">Alejandra Mora has successfully cleared 12 Tutelas this week with 100% compliance.</p>
                </div>
                ...
                <div class="relative z-10 border-t border-gray-700 pt-4 mt-auto flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400">Senior Attorney</p>
                    </div>
                </div>
            </div>
        </div>
