<x-app-layout>
    <div class="max-w-4xl mx-auto py-4">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-[28px] font-bold text-[#0f172a] tracking-tight">Importar Responsables</h1>
            <p class="text-[15px] text-gray-600 mt-1">Sube un archivo con los datos de tus profesionales legales para añadirlos masivamente al sistema.</p>
        </div>

        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            <!-- Formulario de Importación -->
            <form action="{{ route('responsibles.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    ...
                    <div class="bg-gray-50 border border-gray-100 rounded-lg p-5">
                        ...
                        <ul class="text-[12px] font-medium text-gray-500 space-y-1.5 list-disc list-inside">
                            ...
                            <li><span class="text-gray-800">Correo Electrónico</span> (Obligatorio - Único)</li>
                            <li><span class="text-gray-800">Teléfono</span> (Opcional)</li>
                            <li><span class="text-gray-800">Especialidad</span> (Obligatorio - Ej. *General, Civil, Penal*)</li>
                            <li><span class="text-gray-800">Rol</span> (Obligatorio - Ej. *Abogado, Administrador*)</li>
                            <li><span class="text-gray-800">Ubicación</span> (Obligatorio - Ej. *Bogotá, Medellín*)</li>
                            <li><span class="text-gray-800">Hoja de Vida / Resumen</span> (Opcional)</li>
                            <li><span class="text-gray-800">Permisos</span> (Opcional - *casos, aprobaciones, reportes* separados por comas)</li>
                            <li><span class="text-gray-800">Estado</span> (Opcional - *activo, ausente*)</li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-lg p-5 flex flex-col justify-center">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="{{ route('responsibles.template') }}" class="text-[13px] font-bold text-[#1e58c8] hover:text-blue-800 flex items-center gap-1.5 transition-colors">
            ...
            <div class="bg-gray-50 border-t border-gray-200 p-5 flex items-center justify-end gap-3">
                <a href="{{ route('responsibles.index') }}" class="px-5 py-2.5 text-sm font-semibold text-gray-600 hover:bg-gray-200 rounded-lg transition-colors">
                    Cancelar
                </a>
